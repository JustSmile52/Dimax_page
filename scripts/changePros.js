const data = [
  {
    ...
    content1:
      "Skłąda się na nią 30 jednostek lekcyjnych czyli każda po 45 minut. <br>Obejmuje:",
    table: [
  ...
  },
  {
    ...
    content1:
      "Po ukończeniu szkolenia przeprowadzany jest egzamin wewnętrzny na identycznych zasadach co egzamin państwowy. <br>Obejmuje dwie części:",
    table: ["teoretyczną", "praktyczną"],
    content2:
      "Po ukończeniu kursu Ośrodek Szkolenia aktualizuje Profil Kandydata na Kierowcę . Od tego momentu należy udać się do Wojewódzkiego Ośrodka Ruchu Drogowego ( WORD) ,aby zapisać się na egzamin państwowy.",
    photoURL: "https://picsum.photos/id/1/600/400",
  },
];
...
function changeSectionPros(x) {
  ...
  contentHTML += `</ul>`;
  if (data[activePros].content2 != null)
    contentHTML += `<p>${data[activePros].content2}</p>`;
  contentHTML += `</div>`;
