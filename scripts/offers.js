...
let changeTable = () => {
  ...
  document.getElementById(
    "categoryName"
  ).innerText = `Kategoria ${OffersData[active].name}`;
  ...
  categoryContent +=
    '<th class="text-center" colspan="3"><spam class="fs-5">Kursy</spam></th>';
  categoryContent += "</tr>";
  ...
  categoryContent += '<tr class="thead-light">';
  categoryContent +=
    '<th class="text-center" colspan="3"><spam class="fs-5">Inne</spam></th>';
  categoryContent += "</tr>";
  //      Others from JSON
  OffersData[active].other.forEach((other) => {
    ...
    if (other.cost != "") categoryContent += `<td>${other.cost} zł</td></tr>`;
    else categoryContent += `<td>${other.cost}</td></tr>`;
  });
  //      Header "Kursy obejmują"
  categoryContent += '<tr class="thead-light">';
  categoryContent +=
    '<th class="text-center" colspan="3"><spam class="fs-5">Kursy obejmują</spam></th>';
  categoryContent += "</tr>";
